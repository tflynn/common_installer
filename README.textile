...
p. The installation system uses 'wget'. If 'wget' is not present, the installation system will try to use 'curl' to obtain 'wget'.If neither is present, then the system will attempt to install 'wget' using the native installation tools. This version of 'wget' will then be replaced with the 'reference' version from the installation repository.
