...
Anything installed from the source code repository is downloaded, built and remains in ${INSTALLATION_ROOT}/src. INSTALLATION_ROOT by default is /opt1. 
